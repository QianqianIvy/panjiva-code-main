...
# # a test
# df = pd.read_csv('/Users/qianqiantang/Desktop/panjiva-code-main/Processed_data/USImport/PanjivaUSImport2020To2024-10_address.csv')
# # drop rows with non numeric conPanjivaId and shpPanjivaId
# df['conPanjivaId'] = df['conPanjivaId'].astype(str)
# df['shpPanjivaId'] = df['shpPanjivaId'].astype(str)
...
# # duplicate into paris level and year level
# importus = importus.drop(columns=['panjivaRecordId', 'date', 'month', 'day'])
# importus = importus.drop_duplicates()
# importus.head()
...
# # sort conPanjivaId and shpPanjivaId
# importus = importus.sort_values(['conPanjivaId', 'shpPanjivaId', 'year'])
# %%
