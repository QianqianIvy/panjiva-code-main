...
importus = importus.groupby(['year', 'conName', 'conPanjivaId', 'shpPanjivaId', 'conCountry', 'shpCountry', 'shpmtDestination','conFullAddress', 'conRoute', 'conCity', 'conStateRegion', 'conPostalCode']).agg({'volumeTEU': 'sum'}).reset_index()
