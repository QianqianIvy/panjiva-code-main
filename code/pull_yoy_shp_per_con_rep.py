...
for y in range(2020, 2025):
    data_shp_per_con_pivot[y] = (data_shp_per_con_pivot[y] / data_shp_per_con_pivot[2019] - 1) * 100
print(data_shp_per_con_pivot)
data_shp_per_con_pivot = data_shp_per_con_pivot.drop(columns=[2015])
...
data_shp_per_con_pivot['date'] = pd.to_datetime(data_shp_per_con_pivot[['year', 'month']].assign(day=1))
data_shp_per_con_pivot = data_shp_per_con_pivot.dropna(subset=['yoy_growth_rate'])
data_shp_per_con.to_csv('monthly_ave_shp_per_con_2015_2024.csv')
data_shp_per_con_pivot.to_csv('yoy_shp_per_con_2015_2024.csv')
# %%
# %%
# 2015-2024
# Assuming data_shp_per_con_chart is a DataFrame
...
# Customizing the x-axis
ax.set_xlim(pd.to_datetime("2016-01-01"), pd.to_datetime("2024-06-01"))
ax.xaxis.set_major_locator(mdates.MonthLocator(interval=6))  # Every 6 months
ax.xaxis.set_major_formatter(mdates.DateFormatter('%b. %Y'))
...
ax.set_xlabel("")
ax.set_ylabel("")
ax.set_title("Percent change from same month in 2015", fontsize=12)

# Show the plot
plt.show()
fig.savefig('/Users/qianqiantang/Desktop/panjiva-code-main/Result/figure8_2016-2024.png')
# %%
# 2015-2024
# Assuming data_shp_per_con_chart is a DataFrame
# Define approved colors and lines
...
# Customizing the x-axis
ax.set_xlim(pd.to_datetime("2018-01-01"), pd.to_datetime("2024-06-01"))
ax.xaxis.set_major_locator(mdates.MonthLocator(interval=6))  # Every 6 months
ax.xaxis.set_major_formatter(mdates.DateFormatter('%b. %Y'))
...
# Show the plot
plt.show()
fig.savefig('/Users/qianqiantang/Desktop/panjiva-code-main/Result/figure8_2018-2024.png')
